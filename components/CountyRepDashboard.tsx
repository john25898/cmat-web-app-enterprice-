  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="flex max-h-[85vh] w-full max-w-3xl flex-col rounded-lg bg-white shadow-lg">
        {/* Header */}
        <div className="flex shrink-0 items-center justify-between border-b border-gray-200 px-6 py-4 bg-gradient-to-r from-teal-50 to-white rounded-t-lg">
          <div>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          ...
          <div className="rounded-lg bg-indigo-50 border border-indigo-200 p-4 mb-4">
            <p className="text-sm text-indigo-800 italic leading-relaxed">
              &ldquo;I confirm that the details above are correct, and the work
              deliverables/output have been met.&rdquo;
            </p>
          </div>
          ...
          {/* Pre-approval info — Facility In-Charge */}
          ...
          <div className="flex shrink-0 items-center justify-end gap-3 border-t border-gray-200 px-6 py-4">
            {!showReturnForm ? (
              <>
                ...
                <button
                  onClick={onApprove}
                  className="flex items-center gap-2 rounded-lg bg-teal-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-teal-700 shadow-sm"
                >
              ...
              <div className="flex w-full flex-col gap-3">
                <textarea
                  ...
                  rows={2}
                  className="w-full resize-none rounded-lg border border-gray-200 px-4 py-2.5 text-sm text-gray-700 placeholder-gray-400 focus:border-teal-400 focus:outline-none focus:ring-2 focus:ring-teal-100"
                />
                ...
                <>
                  ...
                  {submission.countyRepDate && (
                    <span className="text-xs text-gray-400">
                      on{" "}
                      {new Date(submission.countyRepDate).toLocaleDateString()}
                    </span>
                  )}
                </>
